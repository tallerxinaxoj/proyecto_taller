...
export default function Sidebar() {
  ...
  const PUBLIC_URL = (import.meta as any).env?.VITE_PUBLIC_URL || 'http://localhost:5174';
    ...
    <aside className={`${collapsed ? 'w-20' : 'w-64'} bg-grayish border-r border-gray-700 min-h-screen flex flex-col transition-all duration-200`}>
      ...
      <div className="p-3">
        <button
          ...
          className={`w-full ${collapsed ? 'justify-center' : 'justify-start'} flex items-center gap-2 bg-dark hover:bg-gray-700 px-3 py-2 rounded text-sm text-gray-200`}
        >
